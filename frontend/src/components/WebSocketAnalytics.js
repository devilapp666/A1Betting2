        ...
        children: [
          _jsxs("div", {
            ...
            children: [
              ...
              _jsx("p", { className: "text-2xl", children: metrics.length }),
            ],
          }),
          _jsxs("div", {
            className: "bg-white p-4 rounded shadow",
              ...
              _jsxs(
                "div",
                {
                  ...
                  children: [
                    ...
                    _jsxs("p", {
                      children: ["Messages: ", metric.messageCount],
                    }),
                    _jsxs("p", { children: ["Errors: ", metric.errorCount] }),
                    _jsxs("p", {
                      children: ["Last Error: ", metric.lastError || "None"],
                    }),
                  ],
                },
                index,
