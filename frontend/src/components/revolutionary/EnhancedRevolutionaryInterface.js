...
import { Brain, Activity, Target, BarChart3, Network, TrendingUp, Settings, Eye, RefreshCw, AlertCircle, CheckCircle, Cpu, Sparkles, Radar, GitBranch, Microscope, Gauge, Calculator, Infinity, Sigma, Pi, Triangle, Minimize, Binary, Workflow, BookOpen, GraduationCap, Award, Play, Pause, } from "lucide-react";
