...
import { Home, DollarSign, BarChart3, Brain, Target, Settings, User, Bell, Search, ChevronDown, Plus, Activity, HelpCircle, } from "lucide-react";
...
const CyberModernSidebar = ({ activeItem, onNavigate, user, }) => {
    return (_jsxs("aside", { className: "w-72 h-full bg-gradient-to-b from-gray-900/95 to-black/95 border-r border-cyan-500/20 flex flex-col backdrop-blur-xl", children: [_jsx("div", { className: "p-6 border-b border-cyan-500/30", children: _jsxs("div", { className: "flex items-center gap-4", children: [_jsxs("div", { className: "relative", children: [_jsx("div", { className: "absolute inset-0 bg-gradient-to-r from-cyan-400 to-blue-500 rounded-xl blur-lg opacity-75 animate-pulse" }), _jsx("div", { className: "relative w-12 h-12 bg-gradient-to-br from-cyan-400 to-blue-500 rounded-xl flex items-center justify-center", children: _jsx(Brain, { className: "w-7 h-7 text-black font-bold" }) })] }), _jsxs("div", { children: [_jsx("div", { className: "text-xl font-black tracking-tight bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent", children: "A1BETTING" }), _jsx("div", { className: "text-xs text-cyan-400 uppercase tracking-widest font-semibold", children: "Quantum Intelligence" })] })] }) }), _jsx("div", { className: "p-6 border-b border-cyan-500/20", children: _jsxs("div", { className: "grid grid-cols-3 gap-3", children: [_jsxs(motion.div, { whileHover: { scale: 1.05 }, className: "text-center p-3 rounded-lg bg-gradient-to-b from-emerald-500/20 to-green-600/20 border border-emerald-500/30", children: [_jsxs("p", { className: "text-xl font-bold text-emerald-400", children: [user.winRate, "%"] }), _jsx("p", { className: "text-xs text-emerald-300 font-medium", children: "Win Rate" })] }), _jsxs(motion.div, { whileHover: { scale: 1.05 }, className: "text-center p-3 rounded-lg bg-gradient-to-b from-cyan-500/20 to-blue-600/20 border border-cyan-500/30", children: [_jsxs("p", { className: "text-xl font-bold text-cyan-400", children: ["$", (user.totalProfit / 1000).toFixed(0), "K"] }), _jsx("p", { className: "text-xs text-cyan-300 font-medium", children: "Profit" })] }), _jsxs(motion.div, { whileHover: { scale: 1.05 }, className: "text-center p-3 rounded-lg bg-gradient-to-b from-purple-500/20 to-violet-600/20 border border-purple-500/30", children: [_jsxs("p", { className: "text-xl font-bold text-purple-400", children: [user.accuracy, "%"] }), _jsx("p", { className: "text-xs text-purple-300 font-medium", children: "Accuracy" })] })] }) }), _jsxs("nav", { className: "flex-1 p-4 overflow-y-auto", children: [_jsxs("div", { className: "space-y-1 mb-6", children: [_jsx("div", { className: "text-xs font-bold text-cyan-400 uppercase tracking-wider mb-3 px-2", children: "Core Platform" }), navigationItems.map((item, index) => (_jsxs(motion.button, { initial: { opacity: 0, x: -20 }, animate: { opacity: 1, x: 0 }, transition: { delay: index * 0.1 }, whileHover: { x: 4, scale: 1.02 }, onClick: () => onNavigate(item.id), className: `
              ...
              `, children: [_jsx("div", { className: `${activeItem === item.id ? "text-cyan-400" : "text-gray-400 group-hover:text-cyan-400"} transition-colors`, children: item.icon }), _jsx("span", { className: "font-semibold text-sm flex-1", children: item.label }), item.badge && (_jsx(motion.span, { whileHover: { scale: 1.1 }, className: "px-2 py-1 bg-gradient-to-r from-cyan-500 to-blue-500 text-black text-xs font-bold rounded-full", children: item.badge })), item.shortcut && (_jsx("span", { className: "text-xs text-gray-500 font-mono bg-gray-800/50 px-1.5 py-0.5 rounded border border-gray-700", children: Array.isArray(item.shortcut)
                                            ? item.shortcut.join("")
                                            : item.shortcut }))] }, item.id)))] }), _jsxs("div", { className: "border-t border-cyan-500/20 pt-4", children: [_jsx("div", { className: "text-xs font-bold text-emerald-400 uppercase tracking-wider mb-3 px-2", children: "Elite Features" }), _jsx("div", { className: "space-y-1", children: [
                                ...
                                ].map((feature, index) => (_jsxs(motion.div, { initial: { opacity: 0, x: -10 }, animate: { opacity: 1, x: 0 }, transition: { delay: 0.5 + index * 0.05 }, className: "flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-white/5 cursor-pointer group", children: [_jsx("span", { className: "text-sm", children: feature.icon }), _jsx("span", { className: "text-xs text-gray-400 group-hover:text-gray-300 flex-1", children: feature.name }), _jsx("div", { className: `w-2 h-2 rounded-full ${feature.status === "active"
                                                ? "bg-green-400"
                                                : feature.status === "pro"
                                                    ? "bg-purple-400"
                                                    : feature.status === "premium"
                                                        ...
                                                        : feature.status === "ai"
                                                            ...
                                                            : feature.status === "live"
                                                                ...
                                                                : "bg-orange-400"}` })] }, feature.name))) })] })] }), _jsx("div", { className: "p-4 border-t border-cyan-500/20", children: _jsxs(motion.div, { whileHover: { scale: 1.02 }, className: "flex items-center gap-4 p-4 rounded-xl bg-gradient-to-r from-gray-800/50 to-gray-900/50 border border-gray-700/50 hover:border-cyan-500/30 cursor-pointer transition-all duration-300", children: [_jsxs("div", { className: "relative", children: [_jsx("div", { className: "absolute inset-0 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full blur opacity-75" }), _jsx("div", { className: "relative w-10 h-10 bg-gradient-to-br from-purple-500 to-pink-500 rounded-full flex items-center justify-center", children: _jsx("span", { className: "text-white text-sm font-bold", children: user.name
                                            .split(" ")
                                            .map((n) => n[0])
                                            .join("") }) })] }), _jsxs("div", { className: "flex-1", children: [_jsx("p", { className: "text-sm font-semibold text-white", children: user.name }), _jsxs("p", { className: "text-xs text-cyan-400 font-medium", children: [user.tier, " Member"] })] }), _jsx(motion.div, { whileHover: { rotate: 180 }, children: _jsx(ChevronDown, { className: "w-4 h-4 text-gray-400" }) })] }) })] }));
};
const CyberTopBar = ({ onOpenCommandPalette, onOpenNotifications, currentPage, }) => {
    const currentItem = navigationItems.find((item) => item.id === currentPage);
    return (_jsxs("header", { className: "h-20 bg-gradient-to-r from-gray-900/95 to-black/95 border-b border-cyan-500/30 flex items-center justify-between px-8 backdrop-blur-xl", children: [_jsx("div", { className: "absolute inset-0 bg-gradient-to-r from-cyan-500/5 via-transparent to-blue-500/5 animate-pulse pointer-events-none" }), _jsxs("div", { className: "relative z-10 flex items-center gap-6", children: [_jsxs("div", { className: "flex items-center gap-4", children: [_jsxs(motion.div, { whileHover: { scale: 1.1, rotate: 5 }, className: `
